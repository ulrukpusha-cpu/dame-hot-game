    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 relative z-10">
        ...
        >
          ...
          <motion.a
            href={`https://t.me/${import.meta.env.VITE_BOT_USERNAME || 'DameHotGameBot'}/app`}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-full no-underline cursor-pointer"
            style={{
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              onClick={() => tonService.connectWallet()}
